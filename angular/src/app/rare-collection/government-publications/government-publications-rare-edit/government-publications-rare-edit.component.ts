...
@Component({
  selector: 'app-government-publications-rare-edit',
  templateUrl: './government-publications-rare-edit.component.html',
  styleUrls: ['./government-publications-rare-edit.component.css']
})
export class GovernmentPublicationsRareEditComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<GovernmentPublicationsRareEditComponent>,
